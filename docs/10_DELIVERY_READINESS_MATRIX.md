...
| IAM-002 | IAM-001, PRE-006 | PRE-006 được Chủ dự án duyệt ngày 2026-08-11; contract tại `docs/tasks/IAM-002.md` | IMPLEMENTATION_APPROVED | IAM-002 giữ độc quyền migration/DB verification; production MFA vẫn cần REL-001 | IAM-003, CMS/RMS/Admin dependencies |
