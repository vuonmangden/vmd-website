...
| IAM-003 | IAM-002 | Backend guard + protected sample endpoints; Admin trusted `/auth/me` boundary; Admin 11 và API 63 tests; full local gate đạt | IN_REVIEW | Chờ hosted CI/PR; production vẫn cần REL-001 | Admin/business protected routes |
