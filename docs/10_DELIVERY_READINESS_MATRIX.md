...
| IAM-003 | IAM-002 | PR #18; backend guard + protected sample endpoints; Admin trusted `/auth/me` boundary; Admin 11/API 63 tests và hosted run `31487239678` đạt | DONE (STAGING_ONLY) | Production vẫn cần REL-001 | Admin/business protected routes |
...
| RMS-002 | RMS-001, MNT-014 | Migration Physical Rooms, guarded fixture, API 68, fixture 8 and full local gate achieved | IN_REVIEW (SYNTHETIC_ONLY) | Chờ hosted CI/PR; PRE-002/production vẫn Blocked | RMS-004, RMS-006, BKG-002 |
