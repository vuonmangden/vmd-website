...
| IAM-001 | FND-004, FND-005, PRE-007 | PRE-007 đã có development/staging identity input | PLANNING_ONLY | Thiếu Supabase project/environment, admin domain và callback/CORS origin production được duyệt; không tự dùng development/staging làm production | IAM-002, IAM-004, IAM-005 |
