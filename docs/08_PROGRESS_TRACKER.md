...
| PRE-003 | Chốt bảng giá, phụ thu và cọc | Partial | Chủ dự án | `docs/09_MILESTONE_0_INPUT_PACK.md` §6 | **Bảng giá phòng cơ bản đổi hẳn ngày 2026-08-19** (thay bản 17/8, giá thấp hơn) theo xác nhận chủ dự án. VAT 8% đã gồm, Lễ/Tết cố định +20% (chốt hai lần), hold TTL 2 tiếng, làm tròn xuống nghìn — đều đã chốt. Bỏ gói ăn sáng khỏi giá bán là **chủ động**, không phải thiếu dữ liệu. Còn thiếu: sức chứa tối đa, mã giảm giá mở bán đầu, phạm vi Travel Agent |
...
| PRE-005 | Chốt chính sách hủy, đổi lịch, hoàn tiền | Partial | Chủ dự án | `docs/09_MILESTONE_0_INPUT_PACK.md` §8 | Chính sách hủy BBQ, người duyệt hoàn tiền (Quản lý), SLA (trong ngày), quy tắc hóa đơn (VAT/DHLC) đã chốt ngày 2026-08-19. Chủ dự án giao Claude xây dựng phương án chuyển thiếu/chuyển muộn — đã đề xuất (dung sai 10.000đ, quy trình Quản lý xử lý theo tình trạng phòng/bàn), **chờ chủ dự án duyệt**. Còn thiếu: duyệt đề xuất trên, phụ thu quá giờ BBQ, định nghĩa "cao điểm" |
...
| PAY-004 | Reconciliation | Backlog | PAY-003, PRE-005 |  |  | Chính sách đã đủ để thiết kế: SOP đối soát tham chiếu, người duyệt hoàn tiền, SLA, và đề xuất xử lý chuyển thiếu (dung sai 10.000đ, trạng thái "Chờ bổ sung tiền cọc") / chuyển muộn (Quản lý duyệt thủ công theo tồn phòng/bàn) — `docs/09_MILESTONE_0_INPUT_PACK.md` §8, chờ chủ dự án duyệt số cụ thể trước khi code. Vẫn chờ `PAY-003` xong trước |
