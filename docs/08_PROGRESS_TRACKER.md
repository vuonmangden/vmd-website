...
| Task đang thực hiện | Không có task nào đang code dở; `BBQ-005` vừa triển khai xong, chờ review |
| Task hoàn thành | 61 Done/Review (+1: `BBQ-005` Review 2026-08-22, gồm mở rộng `PaymentIntent` đa hình cho cọc BBQ) — `BBQ-006` sẵn sàng nhận task; `OPS-001` chỉ còn chờ `BKG-008`/`BBQ-006` |
