...
| Task đang thực hiện | Không có task nào đang code dở; `PAY-004` vừa triển khai xong, chờ review |
| Task hoàn thành | 57 Done/Review (+2 hôm nay: `BBQ-001`, `PAY-004`, cả hai đang Review) — mở khóa `BBQ-003` (BBQ Availability); `PAY-005` (Admin Payment) gần đủ điều kiện |
