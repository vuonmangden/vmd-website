...
| RMS-003 | Rate Rules | Review | RMS-001, MNT-014 | `codex/rms-003-rate-rules-sandbox` | Migration blank/deploy x2, seed x2, API 72/72, fixture 8/8; chờ hosted CI | Synthetic-only; PRE-003/PRE-005 vẫn Blocked, không public price hoặc production policy |
