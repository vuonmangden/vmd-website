...
| PRE-004 | Chốt khu vực, bàn, khung giờ và combo BBQ | Partial | Chủ dự án | `docs/09_MILESTONE_0_INPUT_PACK.md` §7 | Nhận **hai bản menu mâu thuẫn** ngày 2026-08-17 (`Demo menu ....pdf` và `MENU ... VER.1.md`): giá lệch tới 5,2×, 7 set với 4 set, chính sách sốt chấm trái ngược. **`BBQ-002` bị chặn cho tới khi chốt bản chính thức.** Khu vực/bàn/khung giờ/cọc BBQ vẫn trống → `BBQ-001`, `BBQ-003` Blocked |
...
| 2026-08-17 | Chủ dự án/Claude | Nhận `MENU VƯỜN MĂNG ĐEN VER.1.md`. Bản này đầy đủ hơn về vận hành (đơn vị tính, số khách mỗi set, thành phần set) nhưng **mâu thuẫn giá nghiêm trọng** với bản Demo PDF: soup cá tầm 188k với 50k, cơm lam 103k với 20k, các set đều lệch, 7 set với 4 set, sốt chấm "không giới hạn" với "chọn 2/4". `BBQ-002` giữ Blocked cho tới khi chủ dự án chốt bản chính thức. Ghi nhận bản VER.1 chứa ghi chú giá vốn và nguồn hàng — phải tách khỏi trường mô tả công khai khi triển khai. |
| 2026-08-17 | Chủ dự án/Claude | Nhận thêm bản Travel Agent và `Demo menu Vuon Mang Den.pdf`. Ghi nhận 7 set combo BBQ, menu à la carte 6 nhóm, hoa hồng agent 12–15% (Net Rate 88%), pháp nhân DHLC/MST 0111330155 và tài khoản MB Bank (số đầy đủ không commit). PRE-004 chuyển `Partial`; khu vực/bàn/khung giờ vẫn trống nên `BBQ-001`/`BBQ-003` giữ Blocked, `BBQ-002` chờ xác nhận menu chính thức. Bản Travel Agent xác nhận cùng thông tin liên hệ với bản khách hàng, củng cố nghi vấn PRE-008 đang sai. |
