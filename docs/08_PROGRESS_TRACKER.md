...
| MNT-012 | PRE-006 decision packet and IAM wave handoff | Review | IAM-001, MNT-011 | `codex/mnt-012-pre006-iam-wave` | IAM-002–IAM-005 planning-only specs; frozen install + full local gate đạt; PRE-006 vẫn chờ owner approval |
