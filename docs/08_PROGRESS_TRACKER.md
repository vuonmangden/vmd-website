...
| Task đang thực hiện | Không có task nào đang code dở; `BBQ-004` vừa triển khai xong, chờ review |
| Task hoàn thành | 60 Done/Review (+5: `BBQ-001`, `PAY-004`, `ADM-001` merged 2026-08-19; `BBQ-003`, `PAY-005` merged, `BBQ-004` Review 2026-08-20) — `BBQ-005`/`BBQ-006` sẵn sàng nhận task; `OPS-001` chỉ còn chờ `BKG-008`/`BBQ-006` |
...
| BBQ-005 | Public BBQ Flow | Backlog | BBQ-004, CMS-005 |  |  | `BBQ-004` xong — sẵn sàng nhận task |
