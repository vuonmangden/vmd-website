...
| IAM-002 | Roles và permissions | Review | IAM-001, PRE-006 | `codex/iam-002-rbac` | Migration blank/deploy x2, seed x2 5/15/46, API 61 tests, full local gate và Supabase staging RBAC E2E đạt | Production/MFA go-live vẫn blocked đến REL-001; chờ hosted CI/PR |
