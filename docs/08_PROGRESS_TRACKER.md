...
| PRE-004 | Chốt khu vực, bàn, khung giờ và combo BBQ | Partial | Chủ dự án | `docs/09_MILESTONE_0_INPUT_PACK.md` §7; `Demo menu Vuon Mang Den.pdf` | Nhận menu ngày 2026-08-17: 7 set combo + à la carte 6 nhóm. **Chờ xác nhận** vì file tên "Demo" nằm trong thư mục thiết kế. Phần khu vực/bàn/khung giờ/cọc BBQ vẫn trống → `BBQ-001` và `BBQ-003` vẫn Blocked |
