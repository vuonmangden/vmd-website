...
| RMS-004 | Room Blocks | Review | RMS-002, MNT-014 | `codex/rms-004-room-blocks-sandbox` | Migration blank/deploy x2, seed x2, API 76/76, fixture 8/8, full local gate; chờ hosted CI | Synthetic-only; không thay `PRE-002`, không public booking |
