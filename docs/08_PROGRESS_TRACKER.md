...
| Task đang thực hiện | Không có task nào đang code dở; `PAY-005` vừa triển khai xong, chờ review |
| Task hoàn thành | 59 Done/Review (+4: `BBQ-001`, `PAY-004`, `ADM-001` merged 2026-08-19; `BBQ-003`, `PAY-005` Review 2026-08-20) — `BBQ-004` (BBQ Booking) sẵn sàng khi cần (phụ thuộc `BBQ-002`/`BKG-001` đã Done); `OPS-001` chỉ còn chờ `BKG-008`/`BBQ-006` (đang Review/Backlog) |
...
| BBQ-004 | BBQ Booking | Backlog | BBQ-002, BBQ-003, BKG-001 |  |  | Hold/idempotency; nên dùng `ResourceHold(resourceType='BBQ_TABLE')` + exclusion constraint `btree_gist` trên `(table_id, tsrange(start,end))` để chặn overlap tuyệt đối — xem `BBQ-003` |
