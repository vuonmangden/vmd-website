...
@Module({ imports: [AuthModule, PaymentsModule], controllers: [RoomTypesController, RoomsController, RoomRateRulesController, RoomBlocksController, RoomPricingController, AvailabilityController, PublicRoomsController, PublicBookingsController, BookingLookupController, BookingGuestRequestsController, AdminBookingsController, CheckInOutController], providers: [RoomTypesService, RoomsService, RoomRateRulesService, RoomBlocksService, PriceEngineService, RoomPricingService, AvailabilityService, OccupancyService, ResourceHoldsService, BookingCreationService, BookingStateService, PublicRoomsService, PublicBookingsService, BookingLookupService, BookingLookupRateLimitService, AdminBookingsService, CheckInOutService, CancellationPolicyService], exports: [RoomTypesService, RoomsService, RoomRateRulesService, RoomBlocksService, PriceEngineService, RoomPricingService, AvailabilityService, OccupancyService, ResourceHoldsService, BookingCreationService, BookingStateService, PublicRoomsService, PublicBookingsService, AdminBookingsService, CheckInOutService, CancellationPolicyService] })
