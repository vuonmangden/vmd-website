...
function holdMinutes(): number { const value=Number.parseInt(process.env['BOOKING_HOLD_MINUTES'] ?? '15',10); return Number.isInteger(value)&&value>0&&value<=30?value:15; }
